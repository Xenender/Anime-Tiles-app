...
public class level_cowboy_bebop extends MainActivity{
    ...
    public level_cowboy_bebop(Button note1, Button note11, Button note111, Button note2, Button note22, Button note222, Button note3, Button note33, Button note333, Button note4, Button note44, Button note444,
        ...
        this.tab_cowboy_bebop = tab_cowboy_bebop;this.arret = arret;this.transition = transition;this.musique = musique;
    ...
    public void start(){
        ...
        */
        ...
        handler.postDelayed(() -> new CountDownTimer((long)(1860/multiplier), (long)(320/multiplier)) {

            @Override
            public void onTick(long millisUntilFinished) {
                fall(tab_cowboy_bebop);
            }
            @Override
            public void onFinish() {
                ...
                handler1.postDelayed(new Runnable() {public void run() {
                    ...
                    new CountDownTimer((long)(4400/multiplier), (long)(1100/multiplier)) {
                        ...
                        public void onFinish() {
                            ...
                            handler1.postDelayed(new Runnable() {public void run() {
                                ...
                                new CountDownTimer((long)(5000/multiplier), (long)(333/multiplier)) {
                                    ...
                                    public void onFinish() {
                                        ...
                                        handler1.postDelayed(new Runnable() {public void run() {
                                            ...
                                            new CountDownTimer((long)(12000/multiplier), (long)(428/multiplier)) {
                                                        ...
                                                        new CountDownTimer((long)(6500/multiplier), (long)(464/multiplier)) {
                                                            ...
                                                            public void onFinish() {
                                                                ...
                                                                handler1.postDelayed(new Runnable() {public void run() {
                                                                    ...
                                                                    new CountDownTimer((long)(12000/multiplier), (long)(600/multiplier)) {
                                                                        ...
                                                                        public void onFinish() {
                                                                            ...
                                                                            handler1.postDelayed(new Runnable() {public void run() {
                                                                                ...
                                                                                new CountDownTimer((long)(13000/multiplier), (long)(419/multiplier)) {
                                                                                    ...
                                                                                    public void onFinish() {
                                                                                        ...
                                                                                        handler1.postDelayed(new Runnable() {public void run() {
                                                                                            ...
                                                                                            new CountDownTimer((long)(12000/multiplier),(long)(705/multiplier)) {
                                                                                                ...
                                                                                                public void onFinish() {
                                                                                                    ...
                                                                                                    handler1.postDelayed(new Runnable() {public void run() {
                                                                                                        ...
                                                                                                        new CountDownTimer((long)(2800/multiplier),(long)(466/multiplier)) {
                                                                                                                    ...
                                                                                                                    new CountDownTimer((long)(4000/multiplier),(long)(500/multiplier)) {
                                                                                                                        ...
                                                                                                                        public void onFinish() {
                                                                                                                            ...
                                                                                                                            handler1.postDelayed(new Runnable() {public void run() {
                                                                                                                                ...
                                                                                                                                new CountDownTimer((long)(5000/multiplier),(long)(357/multiplier)) {
                                                                                                                                        ...
                                                                                                                                        handler1.postDelayed(new Runnable() {
                                                                                                                                            ...
                                                                                                                                            public void run() {
                                                                                                                                                ...
                                                                                                                                                if (!arret[0]) {
                                                                                                                                                    ...
                                                                                                                                                    level_cowboy_bebop recommencer = new level_cowboy_bebop(note1, note11, note111, note2, note22, note222, note3, note33, note333, note4, note44, note444,
