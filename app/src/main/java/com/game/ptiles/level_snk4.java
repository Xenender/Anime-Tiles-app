...
public class level_snk4 extends MainActivity{
    ...
    //et presence de la procédure : Fall() qui permet de parcourir 1 element du tableau des niveaux et de lui appliquer l'animation qui le fera tomber de haut en bas
        ...
        public level_snk4(Button note1, Button note11, Button note111, Button note2, Button note22, Button note222, Button note3, Button note33, Button note333, Button note4, Button note44, Button note444,
            ...
            this.tab_snk4 = tab_snk4;this.arret = arret;this.transition = transition;this.musique = musique;
        ...
        */
            ...
            handler.postDelayed(new Runnable() {public void run() {
                ...
                new CountDownTimer((long)(12800/multiplier), (long)(711/multiplier)) {
                    ...
                    public void onFinish() {
                        ...
                        handler.postDelayed(new Runnable() {public void run() {
                            ...
                            new CountDownTimer((long)(2600/multiplier), (long)(520/multiplier)) {
                                ...
                                public void onFinish() {
                                    ...
                                    handler.postDelayed(new Runnable() {public void run() {
                                        ...
                                        new CountDownTimer((long)(2000/multiplier), (long)(666/multiplier)) {
                                            ...
                                            public void onFinish() {
                                                ...
                                                handler.postDelayed(new Runnable() {public void run() {
                                                    ...
                                                    new CountDownTimer((long)(9400/multiplier), (long)(552/multiplier)) {
                                                                ...
                                                                new CountDownTimer((long)(12000/multiplier), (long)(600/multiplier)) {
                                                                    ...
                                                                    public void onFinish() {
                                                                        ...
                                                                        handler.postDelayed(new Runnable() {public void run() {
                                                                            ...
                                                                            new CountDownTimer((long)(12000/multiplier), (long)(571/multiplier)) {
                                                                                ...
                                                                                public void onFinish() {
                                                                                    ...
                                                                                    handler.postDelayed(new Runnable() {public void run() {
                                                                                        ...
                                                                                        new CountDownTimer((long)(12200/multiplier), (long)(469/multiplier)) {
                                                                                            ...
                                                                                            public void onFinish() {
                                                                                                ...
                                                                                                handler.postDelayed(new Runnable() {public void run() {
                                                                                                    ...
                                                                                                    new CountDownTimer((long)(6300/multiplier),(long)(484/multiplier)) {
                                                                                                        ...
                                                                                                        public void onFinish() {
                                                                                                            ...
                                                                                                            handler.postDelayed(new Runnable() {public void run() {
                                                                                                                ...
                                                                                                                new CountDownTimer((long)(6200/multiplier),(long)(563/multiplier)) {  //DOUBLES RAPIDES
                                                                                                                    ...
                                                                                                                    public void onFinish() {
                                                                                                                        ...
                                                                                                                        handler.postDelayed(new Runnable() {public void run() {
                                                                                                                            ...
                                                                                                                            new CountDownTimer((long)(1750/multiplier),(long)(583/multiplier)) {
                                                                                                                                    ...
                                                                                                                                    handler.postDelayed(new Runnable() {
                                                                                                                                        ...
                                                                                                                                        public void run() {
                                                                                                                                            ...
                                                                                                                                            if(!arret[0]) {
                                                                                                                                                ...
                                                                                                                                                level_snk4 recommencer = new level_snk4(note1, note11, note111, note2, note22, note222, note3, note33, note333, note4, note44, note444,
