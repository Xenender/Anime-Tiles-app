...
public class level_snk1 extends level{
    ...
    public level_snk1(Button note1,Button note11,Button note111,Button note2,Button note22,Button note222,Button note3,Button note33,Button note333,Button note4,Button note44,Button note444,
                      ...
                      float multiplier,
                      int indice,
                      int[] snk1_tab,boolean[] arret,Animation transition,MediaPlayer musique, boolean repetB
        ...
        this.snk1_tab = snk1_tab;this.arret = arret;this.transition = transition;this.musique = musique;
                                                                        ...
                                                                        handler.postDelayed(new Runnable() {
                                                                            ...
                                                                            public void run() {
                                                                                ...
                                                                                if(!arret[0]){
                                                                                    ...
                                                                                    level_snk1 recommencer = new level_snk1(note1, note11, note111, note2, note22, note222, note3, note33, note333, note4, note44, note444,
