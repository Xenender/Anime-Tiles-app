...
public class level_snk7 extends MainActivity{
    ...
    public level_snk7(Button note1,Button note11,Button note111,Button note2,Button note22,Button note222,Button note3,Button note33,Button note333,Button note4,Button note44,Button note444,
        ...
        this.snk7_tab = snk7_tab;this.arret = arret;this.transition = transition;this.musique = musique;
            ...
            public void onFinish() {
                ...
                handler.postDelayed(new Runnable() {
                    public void run() {
                        ...
                        new CountDownTimer((long) (800 / multiplier), (long) (400 / multiplier)) {

                            @Override
                            public void onTick(long millisUntilFinished) {//2
                            ...
                            public void onFinish() {
                                indice=8;
                                new CountDownTimer((long) (600 / multiplier), (long) (200 / multiplier)) {

                                    @Override
                                    public void onTick(long millisUntilFinished) {//3
                                    ...
                                    public void onFinish() {
                                        ...
                                        handler.postDelayed(new Runnable() {
                                            public void run() {
                                                ...
                                                new CountDownTimer((long) (300 / multiplier), (long) (400 / multiplier)) {
                                                    @Override
                                                    public void onTick(long millisUntilFinished) {
                                                    ...
                                                    public void onFinish() {
                                                        ...
                                                        handler.postDelayed(new Runnable() {
                                                            public void run() {
                                                                new CountDownTimer((long) (1200 / multiplier), (long) (400 / multiplier)) {
                                                                    @Override
                                                                    public void onTick(long millisUntilFinished) {
                                                                    ...
                                                                    public void onFinish() {
                                                                        ...
                                                                        new CountDownTimer((long) (8500 / multiplier), (long) (375 / multiplier)) {
                                                                            ...
                                                                            public void onFinish() {
                                                                                indice=41;
                                                                                new CountDownTimer((long) (5000 / multiplier), (long) (250 / multiplier)) {

                                                                                    @Override

                                                                                    public void onTick(long millisUntilFinished) { //7
                                                                                    ...
                                                                                    public void onFinish() {
                                                                                        indice=61;
                                                                                        new CountDownTimer((long) (6000 / multiplier), (long) (400 / multiplier)) {
                                                                                            ...
                                                                                            public void onFinish() {
                                                                                                indice=77;
                                                                                                new CountDownTimer((long) (3800 / multiplier), (long) (200 / multiplier)) {
                                                                                                    ...
                                                                                                    public void onFinish() {
                                                                                                        ...
                                                                                                        new CountDownTimer((long) (6000 / multiplier), (long) (400 / multiplier)) {
                                                                                                            ...
                                                                                                            public void onTick(long millisUntilFinished) { //10
                                                                                                            ...
                                                                                                            public void onFinish() {
                                                                                                                indice=113;
                                                                                                                new CountDownTimer((long) (4000 / multiplier), (long) (250 / multiplier)) {
                                                                                                                    ...
                                                                                                                    public void onFinish() {
                                                                                                                        indice=130;
                                                                                                                        new CountDownTimer((long) (13200 / multiplier), (long) (300 / multiplier)) {
                                                                                                                            ...
                                                                                                                            public void onFinish() {
                                                                                                                                ...
                                                                                                                                handler.postDelayed(new Runnable() {
                                                                                                                                    public void run() {
                                                                                                                                        new CountDownTimer((long) (2000 / multiplier), (long) (200 / multiplier)) {

                                                                                                                                            @Override

                                                                                                                                            public void onTick(long millisUntilFinished) {//13
                                                                                                                                            ...
                                                                                                                                            public void onFinish() {
                                                                                                                                                ...
                                                                                                                                                handler.postDelayed(new Runnable() {
                                                                                                                                                    public void run() {
                                                                                                                                                        new CountDownTimer((long) (13000 / multiplier), (long) (400 / multiplier)) {
                                                                                                                                                            ...
                                                                                                                                                            public void onFinish() {
                                                                                                                                                                indice=219;
                                                                                                                                                                new CountDownTimer((long) (11500 / multiplier), (long) (400 / multiplier)) {//15
                                                                                                                                                                            ...
                                                                                                                                                                            public void run() {
                                                                                                                                                                                new CountDownTimer((long) (600 / multiplier), (long) (200 / multiplier)) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    public void onFinish() {
                                                                                                                                                                                        ...
                                                                                                                                                                                        handler.postDelayed(new Runnable() {
                                                                                                                                                                                            public void run() {
                                                                                                                                                                                                new CountDownTimer((long) (6300 / multiplier), (long) (200 / multiplier)) {
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        handler.postDelayed(new Runnable() {
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            public void run() {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if(!arret[0]){
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    level_snk7 recommencer = new level_snk7(note1, note11, note111, note2, note22, note222, note3, note33, note333, note4, note44, note444,
