...
public class level_mha9 extends MainActivity{
    ...
    //et presence de la procédure : Fall() qui permet de parcourir 1 element du tableau des niveaux et de lui appliquer l'animation qui le fera tomber de haut en bas
        ...
        public level_mha9(Button note1, Button note11, Button note111, Button note2, Button note22, Button note222, Button note3, Button note33, Button note333, Button note4, Button note44, Button note444,
            ...
            this.tab_mha9 = tab_mha9;this.arret = arret;this.transition = transition;this.musique = musique;
            ...
            new CountDownTimer((long)(800/multiplier), (long)(400/multiplier)) {
                ...
                public void onFinish() {
                    ...
                    handler.postDelayed(new Runnable() {public void run() {
                        ...
                        new CountDownTimer((long)(8300/multiplier), (long)(415/multiplier)) {
                            ...
                            public void onFinish() {
                                ...
                                handler.postDelayed(new Runnable() {public void run() {
                                    ...
                                    new CountDownTimer((long)(8400/multiplier), (long)(472/multiplier)) {
                                        ...
                                        public void onFinish() {
                                            ...
                                            handler.postDelayed(new Runnable() {public void run() {
                                                ...
                                                new CountDownTimer((long)(2000/multiplier), (long)(400/multiplier)) {
                                                    ...
                                                    public void onFinish() {
                                                        ...
                                                        handler.postDelayed(new Runnable() {public void run() {
                                                            ...
                                                            new CountDownTimer((long)(2000/multiplier), (long)(250/multiplier)) {
                                                                ...
                                                                public void onFinish() {
                                                                    ...
                                                                    handler.postDelayed(new Runnable() {public void run() {
                                                                        ...
                                                                        new CountDownTimer((long)(2000/multiplier), (long)(222/multiplier)) {
                                                                            ...
                                                                            public void onFinish() {
                                                                                ...
                                                                                handler.postDelayed(new Runnable() {public void run() {
                                                                                    ...
                                                                                    new CountDownTimer((long)(2100/multiplier), (long)(233/multiplier)) {
                                                                                        ...
                                                                                        public void onFinish() {
                                                                                            ...
                                                                                            handler.postDelayed(new Runnable() {public void run() {
                                                                                                ...
                                                                                                new CountDownTimer((long)(15500/multiplier),(long)(387/multiplier)) {
                                                                                                    ...
                                                                                                    public void onFinish() {
                                                                                                        ...
                                                                                                        handler.postDelayed(new Runnable() {public void run() {
                                                                                                            ...
                                                                                                            new CountDownTimer((long)(10000/multiplier),(long)(416/multiplier)) {  //DOUBLES RAPIDES
                                                                                                                ...
                                                                                                                public void onFinish() {
                                                                                                                    ...
                                                                                                                    handler.postDelayed(new Runnable() {public void run() {
                                                                                                                        ...
                                                                                                                        new CountDownTimer((long)(4000/multiplier),(long)(400/multiplier)) {
                                                                                                                            ...
                                                                                                                            public void onFinish() {
                                                                                                                                ...
                                                                                                                                handler.postDelayed(new Runnable() {public void run() {
                                                                                                                                    ...
                                                                                                                                    new CountDownTimer((long)(6000/multiplier),(long)(260/multiplier)) {
                                                                                                                                        ...
                                                                                                                                        public void onFinish() {
                                                                                                                                            ...
                                                                                                                                            handler.postDelayed(new Runnable() {public void run() {
                                                                                                                                                ...
                                                                                                                                                new CountDownTimer((long)(5800/multiplier),(long)(232/multiplier)) {
                                                                                                                                                    ...
                                                                                                                                                    public void onFinish() {
                                                                                                                                                        ...
                                                                                                                                                        handler.postDelayed(new Runnable() {public void run() {
                                                                                                                                                            ...
                                                                                                                                                            new CountDownTimer((long)(3500/multiplier),(long)(318/multiplier)) {
                                                                                                                                                                ...
                                                                                                                                                                public void onFinish() {
                                                                                                                                                                    ...
                                                                                                                                                                    handler.postDelayed(new Runnable() {public void run() {
                                                                                                                                                                        ...
                                                                                                                                                                        new CountDownTimer((long)(4000/multiplier),(long)(285/multiplier)) {
                                                                                                                                                                                ...
                                                                                                                                                                                handler.postDelayed(new Runnable() {
                                                                                                                                                                                    ...
                                                                                                                                                                                    public void run() {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if(!arret[0]) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            level_mha9 recommencer = new level_mha9(note1, note11, note111, note2, note22, note222, note3, note33, note333, note4, note44, note444,
